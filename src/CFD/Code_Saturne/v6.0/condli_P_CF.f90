...
use cs_push_force_MUI_Coupling_Module
...
integer :: barrier
double precision tPushStart, tPushEnd, tCommitStart, tCommitEnd
...
! MUI push
    ...
    if (local_push) then
        if (push_force_MUI) then
            if (push_in_C) then

            else
                call cs_push_force_MUI_Coupling ()
            endif
        else
            call push_Field_MUI        &
          ( 'pressure',                &
...
! MUI commit
    ...
    if (local_push) then
        call commit_MUI_Coupling(sub_iteration_MUI_Coupling, nbsubcpl)
    endif
...
!===============================================================================
! MUI modified usalcl subroutine for fetch
  ...
  call usalcl &
    ...
    impale ,                                                       &
    dt     ,                                                       &
    rcodcl , xyzno0 , disale, nbsubcpl,  &
    fr, ak, IQNILS)

! MUI modified usalcl subroutine for fetch end
!===============================================================================
...
if (iale.ge.1 .and. itrale.gt.nalinf) then
  call altycl &
...
!===============================================================================
! MUI local variables setup
integer    ::    sub_iteration_MUI_Coupling
double precision und_relx_coupling
type(muiCouplingFixedRelaxation) :: fr
type(muiCouplingAitken) :: ak
type(muiCouplingIQNILS) :: IQNILS
...
! MUI modified usalcl subroutine for fetch
  call usalcl &
    ...
    impale ,                                                       &
    dt     ,                                                       &
    rcodcl , xyzno0 , disale, italimTemp,  &
    fr, ak, IQNILS)
