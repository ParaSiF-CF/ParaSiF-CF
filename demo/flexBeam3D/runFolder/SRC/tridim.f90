...
subroutine tridim &
 ( itrale ,                                                       &
   nvar   , nscal  ,                                              &
   dt , sub_iteration_MUI_Coupling, &
   nbsubcpl, und_relx_coupling, push_force_MUI, &
...
!===============================================================================
! MUI sub-iteration return point
    if (nbsubcpl.ge.sub_iteration_MUI_Coupling) then
      itrfin = -1
      nbsubcpl = 1
    endif
    !     On boucle eventuellement sur de deplacement des structures
...
! MUI sub-iteration return point end
!===============================================================================
